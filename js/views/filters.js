        ...
        var ele = "<div key='" + key + "' id='p_" + filters[key].hash + "' class='ex-log-row'>"
            + "<div style='width:100%; display:inline-block; font-size:12px'>"
                + "<div style='float:left; padding-right:5px; margin-top:4px'><img src='../assets/arrow_normal.png' width='8' /></div>"
                    ...
                    + "<div style='float:right'><div key='" + key + "' id='bfd_" + filters[key].hash + "' style='float:left' class='ex-ui-icon-delete-filter' title='Delete filter'></div></div>"
                    + "<div style='float:right'><div hash='" + filters[key].hash + "' key='" + key + "' id='bfe_" + filters[key].hash + "' style='float:left; margin-right:3px' class='ex-ui-icon-edit-filter' title='Edit filter'></div></div>"
